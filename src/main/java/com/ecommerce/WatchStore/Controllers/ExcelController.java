...
public class ExcelController {
    ...
    @GetMapping("/export-receipt-pdf/{id}")
    public void exportToPdfReceipt(HttpServletResponse response, @PathVariable Long id) throws IOException {
        excelService.exportToPdf(response, id);
    }
